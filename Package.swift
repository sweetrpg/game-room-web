...
let package = Package(name: "sweetrpg-library-web",
        dependencies: [
            ...
            .package(name: "sweetrpg-sdk", url: "ssh://git@github.com/sweetrpg/sdk.git", .branch("develop")),
            ...
            .package(name: "sweetrpg-profiles-model", url: "ssh://git@github.com/sweetrpg/profiles-model.git", .branch("develop")),
